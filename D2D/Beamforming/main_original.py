...
class IGCNet(torch.nn.Module):
    def __init__(self):
        ...
        self.mlp2 = Seq(*[self.mlp2, Seq(Lin(64, 2 * Nt))])
        self.conv = IGConv(self.mlp1, self.mlp2)
